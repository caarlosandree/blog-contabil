export function DashboardCards() {
  return (
    ...
    >
      <div className="bg-white p-6 rounded-xl shadow-sm border border-slate-200 flex flex-col justify-between hover:shadow-md transition">
        ...
        <h3 className="text-3xl font-bold text-slate-800 mb-1">53,84%</h3>
      ...
      <div className="bg-white p-6 rounded-xl shadow-sm border border-slate-200 flex flex-col justify-between hover:shadow-md transition">
        ...
        <h3 className="text-3xl font-bold text-slate-800 mb-1">-20%</h3>
        <p className="text-sm text-slate-600">
      ...
      <div className="bg-white p-6 rounded-xl shadow-sm border border-slate-200 flex flex-col justify-between hover:shadow-md transition">
        ...
        <h3 className="text-3xl font-bold text-slate-800 mb-1">Mensal</h3>
        <p className="text-sm text-slate-600">
