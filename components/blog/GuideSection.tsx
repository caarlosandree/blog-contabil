        ...
        {filteredItems.length === 0 ? (
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            {filteredItems.map((item) => {
              const borderColorMap: Record<GuideCategory, string> = {
                riscos: 'border-red-500',
                organização: 'border-[#0F4C52]',
                financeiro: 'border-green-500',
                fiscal: 'border-amber-500',
              };
              ...
              return (
                ...
                >
                  ...
                  <h3 className="text-lg font-bold text-[#082D31] mb-2">
                    {item.title}
                  </h3>
