export function HeroSection() {
  return (
    <section className="bg-white rounded-2xl shadow-sm border border-slate-200 overflow-hidden relative">
      <div className="absolute top-0 right-0 -mt-4 -mr-4 w-32 h-32 bg-blue-300 rounded-full opacity-20 blur-xl"></div>
      <div className="p-8 md:p-12 relative z-10">
        <span className="inline-block py-1 px-3 rounded-full bg-blue-300 text-blue-900 text-xs font-bold uppercase tracking-wide mb-4">
          Infoprodutores
        </span>
        ...
        <p className="text-slate-600 text-lg max-w-3xl mb-8">
        ...
        <div className="flex flex-wrap gap-4">
          <a
            href="#guia"
            className="bg-blue-900 text-white px-6 py-3 rounded-lg font-semibold hover:bg-blue-950 transition shadow-lg hover:shadow-xl"
          >
            Explorar o Guia
          </a>
          <a
            ...
            className="flex items-center gap-2 text-blue-900 font-semibold px-6 py-3 border border-blue-900 rounded-lg hover:bg-blue-50 transition"
          >
            <svg
              className="w-5 h-5"
              fill="currentColor"
